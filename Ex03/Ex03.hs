...
dnub456 :: (Eq a) => [a] -> [a]
dnub456 xs = dnubFn (nub xs)
    where
        dnubFn [] = []
        dnubFn (x:xs) = xs ++ [x]

dnub456_c1 :: [Int]
dnub456_c1 = [1, 2, 2, 2, 3, 4]

dnub456_c2 :: (Int,[Int])
dnub456_c2 = (1, [1, 2, 2, 2, 3, 4])

dnub456_c3 :: ([Int],[Int]) -- (xs,ys)
dnub456_c3 = ([1, 1, 3, 5, 5], [2, 2, 4])
